...
<?php 
  if(isset($_GET['prod_id']))
  {
    ...
    $view_prod = mysqli_query($connect,"select p.*,pc.*,cb.* from tbl_product p,tbl_product_category pc,tbl_subcategory cb where fld_product_id='".$_GET['prod_id']."' and pc.fld_product_category_id=p.fld_product_category_id and cb.fld_subcategory_id=p.fld_subcategory_id order by p.fld_product_id desc") or die (mysqli_error($connect));
                  ...
                  <div class="product-buy">
                    ...
                    <?php }?>
                      <?php 
                          ...
                          {
                        ?>
                        <a href="wishlist_add.php?w_id=<?php echo $fetch_prod['fld_product_id'];?>" class="btn min">
                    ...
                    <div class="single-product-info">
                      ...
                      <p>Product Type : <a href="#"><?php echo $fetch_prod['fld_subcategory_name'];?></a>
                      </p>
                      <p>Weight : <a href="#"><?php echo $fetch_prod['fld_product_weight'];?></a>
                      </p>
                    </div>
                  </div>
                </div>
                          ...
                          <div class="col-12">
                            <div class="single-des">
                              ...
                              <ul>
                                ...
                                <li><b>Weight</b> : <?php echo $fetch_prod ['fld_product_weight'];?> Kgs</li>
                                <li><b>Dimension</b> : <?php echo $fetch_prod ['fld_product_dimension'];?> cm</li> 
                                <li><b>Width</b> : <?php echo $fetch_prod ['fld_product_width'];?> cm</li>
                                <li><b>Colour</b> : <?php echo $fetch_prod ['fld_product_colour'];?></li>
                              </ul>
                            </div>
                          </div>
                        </div>
